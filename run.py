...
class Run():
    def __init__(self,
        ...
        # Updated to work with new config format (single experiment)
        self.src = config['src_tgt_pairs']['src']
        self.tgt = config['src_tgt_pairs']['tgt']
        self.uid_all = config['src_tgt_pairs']['uid']
        self.iid_all = config['src_tgt_pairs']['iid']
        self.batchsize_src = config['src_tgt_pairs']['batchsize_src']
        self.batchsize_tgt = config['src_tgt_pairs']['batchsize_tgt']
        self.batchsize_meta = config['src_tgt_pairs']['batchsize_meta']
        self.batchsize_map = config['src_tgt_pairs']['batchsize_map']
        self.batchsize_test = config['src_tgt_pairs']['batchsize_test']
